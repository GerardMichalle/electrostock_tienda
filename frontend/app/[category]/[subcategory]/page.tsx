      ...
      <>
        ...
        <main className="flex flex-1 items-center justify-center px-4 py-16 sm:px-6">
          <div className="text-center">
            <p className="text-text-muted">Esta subcategoría no existe.</p>
            <Link
              href="/"
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[220px_1fr]">
            <CategorySidebar category={category} activeSubSlug={subSlug} />
            ...
            <div>
              ...
              {ready && productList.length === 0 ? (
                <p className="border border-dashed border-border p-8 text-center text-sm text-text-muted">
                  Aún no hay productos publicados en esta subcategoría.
                </p>
              ) : (
